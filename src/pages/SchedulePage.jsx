...
const SchedulePage = () => {
  ...
  if (isLoading) {
    return (
      <PageTransition loading={true} loadingMessage="Memuat jadwal konsultasi...">
        <div className="space-y-8">
          ...
          <div className="py-16 bg-white">
            <div className="max-w-5xl mx-auto px-4">
              ...
              <div className="bg-primary.light rounded-3xl p-6 mt-6">
                <SkeletonLoader lines={2} />
              </div>
            </div>
          </div>
          ...
          <div className="py-12">
            <div className="max-w-5xl mx-auto px-4">
              ...
              <div className="divide-y divide-slate-200 rounded-3xl border border-slate-200 bg-white mt-4">
                {[1, 2, 3].map((i) => (
